...
export default class ProblemDetails extends Component {
    ...
    render() {
        const {selectedProblem, displayEditor} = this.state;
        return (
                ...
                <div className = "problem_content">
                    ...
                    <div className = "problem-example">                   
                        <div className = "col span-1-of-2 example_input">
                            <h3 >입력 예제 1</h3><br/>
                            <textarea className="form-control example_text" cols="55"rows="12" disabled value = {selectedProblem.input_example}>
                            </textarea>
                        </div>
                        <div className = "col span-1-of-2 example_output">
                            <h3 >출력 예제 1</h3><br/>
                            <textarea className="form-control example_text" cols="55" rows="12" disabled  value =  {selectedProblem.output_example}>
                            </textarea>
                        </div>
                    </div>    
                </div>
